...
<body>
	...
	document.write("객체의 이벤트 리스러(감지기)는? : "+p.onclick+"<br>");
	...
	//document.close();    일단 주석처리
	function winOpen(){
		
		window.open("<%=request.getContextPath()%>/member/memberJoin.jsp","winNanme","width=800, heigth=600;")
	...
	<br>
	아침에는 <span class = "b">우유</span>도 같이 마시고 있어요
